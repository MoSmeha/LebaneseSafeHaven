...
const initialData = [
  ...
  },
  {
    ...
    numBedrooms: 4,
    pictures: [
      "https://www.gpsmycity.com/img/ctw/507.jpg",
      "https://images.pexels.com/photos/1643383/pexels-photo-1643383.jpeg",
...
function App() {
  ...
  const [houses, setHouses] = useState(() => {
    ...
    if (savedHouses) {
      return JSON.parse(savedHouses);
    }
    // If no saved data, initialize with the initial data array
    return initialData;
  });
  ...
  // la7ata netfeda l side effects we use useEffect here
  useEffect(() => {
    ...
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route
          path="/apartments"
          element={
            <Apartments data={houses} query={query} setQuery={setQuery} />
          }
        />
        <Route
          path="/add"
